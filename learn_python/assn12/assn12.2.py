...
Actual problem: Start at: http://python-data.dr-chuck.net/known_by_Jackson.html
...
answer = re.findall(r'by_([A-Z][a-z]+)', url)
print "The answer to the assignment for this execution is {}".format(answer[0])
